...
use plotly::{
    ...
    histogram::Bins,
    layout::{Axis, BarMode},
    HeatMap, Histogram, Layout, Plot, Scatter,
};
use rayon::prelude::*;
...
mod tests {
    ...
    mod tests {
        ...
        fn test_compress_grok_and_wiki() {
            ...
            let page1_g = read_from_file("../../dataset/grokvswiki/page/Web_fiction.html");
            let page1_g = kolmox::filter::content::grok::get_content(&page1_g).unwrap();
            let page1_w = read_from_file("../../dataset/grokvswiki/wiki/Web_fiction.html");
            ...
            let page2_g = read_from_file("../../dataset/grokvswiki/page/Arra_San_Agustin.html");
        ...
        #[test]
        fn test_plagiarism() {
            let page_wiki = read_from_file("assets/wikipedia.txt");
            let page_ruwiki = read_from_file("assets/ruwiki.txt");
